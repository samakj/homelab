...
Homelab::Sensors::LD2410S::LD2410S(uint8_t _rx, uint8_t _tx, std::string _id) : rx(_rx), tx(_tx), id(_id)
{
    ...
    Homelab::Server->addSource(id, [this]()
                               { return Homelab::Sensors::LD2410S::getJsonValue(); }, [this]()
                               { return Homelab::Sensors::LD2410S::getJsonSchemaValue(); });
    Homelab::Server->addSource(id + "/config", [this]()
                               { return Homelab::Sensors::LD2410S::getConfigureJsonValue(); }, [this]()
                               { return Homelab::Sensors::LD2410S::getConfigureJsonSchemaValue(); });
    Homelab::Server->addSink(id + "/config", [this](std::string json)
                             { return Homelab::Sensors::LD2410S::receiveConfigureJsonValue(json); }, [this]()
                             { return Homelab::Sensors::LD2410S::receiveConfigureJsonSchemaValue(); });
}
...
std::string Homelab::Sensors::LD2410S::getJsonValue()
{
    JsonDocument json;
...
std::string Homelab::Sensors::LD2410S::getJsonSchemaValue()
{
    return "{"
           "\"type\":\"object\","
           "\"properties\":{"
...
std::string Homelab::Sensors::LD2410S::getConfigureJsonValue()
{
    JsonDocument json;
...
std::string Homelab::Sensors::LD2410S::getConfigureJsonSchemaValue()
{
    return "{"
           "\"type\":\"object\","
           "\"properties\":{"
...
void Homelab::Sensors::LD2410S::receiveConfigureJsonValue(std::string _json)
{
    JsonDocument json;
    ...
    else
    {
        ...
        if (json["distanceTolerance"].is<float>())
        {
            float _distanceTolerance = json["distanceTolerance"];
...
std::string Homelab::Sensors::LD2410S::receiveConfigureJsonSchemaValue()
{
    return "{"
           "\"type\": \"object\","
           "\"properties\": {"
