...
namespace Homelab::Peripherals
{
    ...
    public:
        Neopixels(uint16_t _noPixels, int8_t _pin, std::string _id = "neopixels", neoPixelType _type = NEO_GRBW + NEO_KHZ800);
        ...
        NeopixelColour_t getInterpolatedPixelColour(uint16_t pixelIndex);
