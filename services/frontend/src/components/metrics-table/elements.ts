...
export const MetricsTableElement = styled.table`
  border: 1px solid ${({ theme }) => theme.colours.border.light};
  border-collapse: collapse;
`;

export const MetricsTableHeaderCellElement = styled.th`
  font-weight: normal;
  font-size: 0.75rem;
...
export const MetricsTableCellElement = styled.td`
  border-top: 1px solid ${({ theme }) => theme.colours.border.light};
  border-bottom: 1px solid ${({ theme }) => theme.colours.border.light};
  padding: 0.5rem;
`;

export const MetricsTableNameCellElement = styled(MetricsTableCellElement)`
