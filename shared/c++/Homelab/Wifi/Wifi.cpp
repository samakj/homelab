...
Homelab::Wifi::Credentials *Homelab::Wifi::getStrongestNetwork(std::vector<Homelab::Wifi::Credentials *> _networks)
{
    if (!_networks.size())
    {
...
void Homelab::Wifi::setMaxWait(uint16_t _maxWait)
{
    Homelab::Wifi::maxWait = _maxWait;
};
...
void Homelab::Wifi::connect(Homelab::Wifi::Credentials *_network, std::string hostname, std::string ip)
{
...
void Homelab::Wifi::connect(std::vector<Homelab::Wifi::Credentials*> _networks, std::string hostname, std::string ip)
{
