...
Homelab::Graphics::Elements::Rectangle::Rectangle(
    int16_t x, int16_t y, int16_t height, int16_t width, uint16_t fill, uint16_t background, uint8_t zIndex
...
void Homelab::Graphics::Elements::Rectangle::draw(TFT_eSPI *tft) {
    ...
    this->boundingBox.displayed.topLeft = {this->x.displayed, this->y.displayed};
    this->boundingBox.displayed.bottomRight = {this->x.displayed + this->width.displayed, this->y.displayed + this->height.displayed};
};
