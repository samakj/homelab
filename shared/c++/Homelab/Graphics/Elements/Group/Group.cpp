...
Homelab::Graphics::Elements::Group::Group(
    std::vector<Homelab::Graphics::Elements::Element*> _children, uint8_t zIndex
)
...
void Homelab::Graphics::Elements::Group::addChild(Homelab::Graphics::Elements::Element* child)
{
  ...
  std::sort(
      ...
      Homelab::Graphics::Elements::Element::compareZIndex
  );
  this->recalculateDimensions();
}

void Homelab::Graphics::Elements::Group::addChildren(
...
{
  for(Homelab::Graphics::Elements::Element* child : this->children)
    if(child->hasChangesToDisplay()) return true;
  return false;
}

void Homelab::Graphics::Elements::Group::clear(TFT_eSPI* tft)
{
  for(Homelab::Graphics::Elements::Element* child : this->children) child->clear(tft);
}

void Homelab::Graphics::Elements::Group::draw(TFT_eSPI* tft)
{
  for(Homelab::Graphics::Elements::Element* child : this->children) child->draw(tft);
}

void Homelab::Graphics::Elements::Group::loop(TFT_eSPI* tft)
{
